 ...
 */
async function loadSavedCredentialsIfExist(client: OAuth2Client): Promise<OAuth2Client | null> {
    try {
...
async function authorize(): Promise<OAuth2Client> {
    ...
    return new Promise((resolve, reject) => {
        ...
        }).listen(3000, () => { // Ensure this port matches the one in REDIRECT_URI
...
async function listEventsForDay(
    ...
    targetDate: Date
): Promise<calendar_v3.Schema$Event[] | undefined> { // Return events array or undefined
